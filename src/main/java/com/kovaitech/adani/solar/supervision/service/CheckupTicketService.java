...
public class CheckupTicketService {
    ...
    public String createOrUpdateTicket(CheckupTicket ticket) throws JsonProcessingException {
        ticket.setStatus("Pending");
        initializeCheckList(ticket);
        return checkupTicketRepo.save(ticket).getId();
    }

    private void initializeCheckList(CheckupTicket ticket) throws JsonProcessingException {
        List<CheckListItem> checkListItems = new ArrayList<>();
        List<String> names = mapper.readValue(getNames(),
